...
public class MFProj {
     ...
     */
        ...
        //main method
        {
            ...
            System.out.println("Please enter 'M' to launch the Millennium Falcon");
            char laun = in.next().charAt(0);

            while (laun != 'M' && laun != 'm') {
                System.out.println("You did not enter the letter 'M'! Try again!");
        ...
        /* does first run; if this run has all people on board as
          ready, the program ends. Otherwise, the runs continue in the while loop */
            i++;
        ...
        /* while the sum of all of the people on board is not 6
            ...
            Each characters should == 1 and therefor, the sum should be 6 */ {
                ...
                //figures out if the sum of the people on board is 6; then breaks if positive
